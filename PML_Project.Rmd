...
The decision Tree had only a 72% acccuracy. Let's try the Random Forect and see if we can get better results.
```{r fig.width=10, fig.height=10}
...
The Random Forest yielded much better results at better than 99%
