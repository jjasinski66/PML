...
The decision Tree had only a 72% acccuracy. I would expect a 28% error rate on this model.
...
modelRF <- train(classe ~ ., data=trainData, method="rf", trControl=control, ntree=100)
...
With an accuracy of 99.46% with the Random Forest, I would expect less than 1% error rate.

```{r}

accuracy <- postResample(rfPredictions, testData$classe)
accuracy
...
The Random Forest yielded much better results than the Decision Tree, so I will use this model for my predictions.
