...
The decision Tree had only a 72% acccuracy, with a 28% out of sample error rate
...
The Random Forest yielded much better results with over 99% accuracy and less than 1% out of Sample Error.
